...
│   └── day4_prompt_engineering.py  # Prompt engineering techniques
│
├── week2/
...
Tiered (Gemini Flash / GPT-4o / Sonnet)
...
For local inference setup, see instructions.md.
